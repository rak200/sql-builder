...
final class ColumnTest extends TestCase {
    ...
    public function testMinimalColumnRendersNullable(): void {
        $this->assertSame('`id` BIGINT NULL', (string) Column::create('id', DataType::BigInt));
    }

    public function testLengthIsEmittedInParens(): void {
    ...
    public function testDefaultQuotesStringValue(): void {
    ...
    public function testDefaultPassesThroughExpressions(): void {
