...
/**
 * Renders an {@see ExistsExpression} as `EXISTS (subquery)`.
 *
 * @package Rak200\SqlBuilder\Dialect\Renderer\Common
 * @author rak200 <rak.ricardo@windowslive.com>
 */
class ExistsExpressionRenderer implements ComponentRenderer {

    public function __construct(protected Dialect $dialect) {}

    public function render(ExistsExpression $component): string {
        $sql = sprintf(
            '%s (%s)',
